 ...
 * @author Admin
 */
public class PetStatistic extends javax.swing.JFrame {
    class CategoryItem
    {
        private int id = 0;
        private String name = "";
...
//    }
    ...
    public void showImportAndExportNumber(Date fromDate, Date toDate){
        int beginNumber = PetDao.getBeginPet(fromDate, toDate);
        lblBegin.setText(Integer.toString(beginNumber));
        int importNumber = PetDao.getImportPet(fromDate, toDate);
        lblImportNumber.setText(Integer.toString(importNumber));
        int exportNumber = PetDao.getExportPet(fromDate, toDate);
    ...
    public void showImportChart(Date fromDate, Date toDate){
        ArrayList<Object[]> listBegin = PetDao.getBeginCountByPetCategory(fromDate, toDate);
        ArrayList<Object[]> listImport = PetDao.getImportCountByPetCategory(fromDate, toDate);
        ArrayList<Object[]> listExport = PetDao.getExportCountByPetCategory(fromDate, toDate);
...
//        }
        ...
        final JFreeChart chart = ChartFactory.createBarChart(
            "Biểu đồ nhập/xuất/tồn kho",       // chart title
            "Loại thú cưng",               // domain axis label
    ...
    public void showTypePieChart(Date fromDate, Date toDate, int typeId, String typeData){
        ...
        if(typeId == 0){
            if(typeData.equals("Tồn đầu kì")){
                categoryList = PetDao.getBeginCountByPetCategory(fromDate, toDate);
            ...
            if(typeData.equals("Nhập")){
                categoryList = PetDao.getImportCountByPetCategory(fromDate, toDate);
                for (Object[] categoryObj : categoryList) {
                    dataset.setValue((categoryObj[0].toString()), Integer.parseInt(categoryObj[1].toString()));
                }
            }
            if(typeData.equals("Xuất")){
                categoryList = PetDao.getExportCountByPetCategory(fromDate, toDate);
                for (Object[] categoryObj : categoryList) {
                    dataset.setValue((categoryObj[0].toString()), Integer.parseInt(categoryObj[1].toString()));
                }
            }
            ...
            if(typeData.equals("Tồn đầu kì")){
                categoryList = PetDao.getBeginCountByPetType(fromDate, toDate, typeId);
                for (Object[] categoryObj : categoryList) {
                    dataset.setValue((categoryObj[0].toString()), Integer.parseInt(categoryObj[1].toString()));
                }
            }
            if(typeData.equals("Nhập")){
                categoryList = PetDao.getImportCountByPetType(fromDate, toDate, typeId);
                for (Object[] categoryObj : categoryList) {
                    dataset.setValue((categoryObj[0].toString()), Integer.parseInt(categoryObj[1].toString()));
                }
            }
            if(typeData.equals("Xuất")){
                categoryList = PetDao.getExportCountByPetType(fromDate, toDate, typeId);
                for (Object[] categoryObj : categoryList) {
                    dataset.setValue((categoryObj[0].toString()), Integer.parseInt(categoryObj[1].toString()));
                }
            }    
            if(typeData.equals("Tồn cuối kì")){
                ArrayList<Object[]> listBegin = PetDao.getBeginCountByPetType(fromDate, toDate, typeId);
                ArrayList<Object[]> listImport = PetDao.getImportCountByPetType(fromDate, toDate, typeId);
                ArrayList<Object[]> listExport = PetDao.getExportCountByPetType(fromDate, toDate, typeId);
...
//        plot.setSectionPaint(KEY2, Color.red);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 650, 400));
        ...
        getContentPane().add(pnlPieCategoryChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 70, 570, 270));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 350, 570, 300));
        ...
        jPanel3.add(lblBegin, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 32, -1, 60));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PetStatistic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
